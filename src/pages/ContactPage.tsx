    ...
    <>
      ...
      <div className="bg-white min-h-screen">
        {/* ========================================================
            ...
            ======================================================== */}
        <section className="bg-gradient-to-r from-[#031b4e] via-[#046BD2] to-[#15ace6] text-white pt-14 pb-36 sm:pb-44 lg:pb-52 px-4 sm:px-6 lg:px-8 relative overflow-hidden text-center">
          ...
          <div className="max-w-4xl mx-auto relative z-10 space-y-4">
            {/* Centered Breadcrumb */}
            <nav className="inline-flex items-center justify-center space-x-2 text-xs sm:text-sm text-sky-100 font-medium mb-1">
              <button 
                onClick={() => onNavigate('/')}
            ...
            {/* Subtitle */}
            <p className="text-sky-100 text-sm sm:text-base lg:text-lg max-w-2xl mx-auto leading-relaxed pt-1">
        ...
        <section className="relative -mt-24 sm:-mt-32 lg:-mt-36 pb-20 px-4 sm:px-6 lg:px-8 z-20">
          <div className="max-w-5xl mx-auto bg-white rounded-[28px] sm:rounded-[36px] shadow-2xl shadow-[#031b4e]/20 border border-slate-100 overflow-hidden grid grid-cols-1 lg:grid-cols-12">
            
            {/* Left Column: Contact Information (Midnight Navy) */}
            <div className="lg:col-span-5 bg-[#031b4e] p-8 sm:p-10 lg:p-12 text-white flex flex-col justify-between text-left">
              <div className="space-y-4">
                ...
                <div className="space-y-6 pt-6 sm:pt-8">
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-11 h-11 rounded-full bg-white/10 text-[#15ace6] flex items-center justify-center shrink-0 mt-0.5">
                      <Phone className="w-5 h-5" />
                    </div>
                    <div>
                      <span className="text-xs font-semibold text-sky-200 block">Phone</span>
                      <a 
                        href={`tel:${siteConfig.phoneRaw}`} 
                        className="text-base font-bold text-white hover:text-[#15ace6] transition-colors mt-0.5 block"
                      >
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <span className="text-xs font-semibold text-sky-200 block">Email</span>
                      <a 
                        href={`mailto:${siteConfig.email}`} 
                        className="text-base font-bold text-white hover:text-[#15ace6] transition-colors mt-0.5 block break-all"
                      >
                        {siteConfig.email}
                      </a>
                    </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <span className="text-xs font-semibold text-sky-200 block">Office</span>
              ...
              {isSuccess ? (
                <div className="text-center py-10 space-y-4">
                  ...
                  <p className="text-slate-600 text-sm max-w-md mx-auto leading-relaxed font-normal">
                    Thank you for reaching out to Webwizia. Our team will review your inquiry and get back to you within 24 hours at <span className="font-bold text-[#031b4e]">{formData.email}</span>.
                  </p>
                  <div className="pt-4">
                    <button
                      onClick={handleReset}
                      className="px-8 py-3.5 bg-gradient-to-r from-[#046BD2] to-[#15ace6] hover:from-[#0353a4] hover:to-[#0d99d1] text-white font-bold rounded-xl text-xs uppercase tracking-wider shadow-md transition-all"
                    >
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-bold text-[#031b4e] mb-1.5">
                        Full Name *
                      </label>
                      <input
                        ...
                        className={`w-full px-4 py-3 rounded-xl bg-[#f2f9fd] border focus:bg-white text-sm text-[#031b4e] placeholder-slate-400 focus:outline-none transition-all ${
                          errors.fullName ? 'border-red-400 focus:border-red-400' : 'border-sky-100 focus:border-[#046BD2]'
                        }`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 rounded-xl bg-[#f2f9fd] border focus:bg-white text-sm text-[#031b4e] placeholder-slate-400 focus:outline-none transition-all ${
                          errors.email ? 'border-red-400 focus:border-red-400' : 'border-sky-100 focus:border-[#046BD2]'
                        }`}
                      />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 rounded-xl bg-[#f2f9fd] border focus:bg-white text-sm text-[#031b4e] placeholder-slate-400 focus:outline-none transition-all ${
                          errors.phone ? 'border-red-400 focus:border-red-400' : 'border-sky-100 focus:border-[#046BD2]'
                        }`}
                      />
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-[#f2f9fd] border border-sky-100 focus:border-[#046BD2] focus:bg-white text-sm text-[#031b4e] focus:outline-none transition-all cursor-pointer"
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className={`w-full px-4 py-3.5 rounded-xl bg-[#f2f9fd] border focus:bg-white text-sm text-[#031b4e] placeholder-slate-400 focus:outline-none transition-all resize-none ${
                        errors.message ? 'border-red-400 focus:border-red-400' : 'border-sky-100 focus:border-[#046BD2]'
                      }`}
                    />
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="w-full py-3.5 sm:py-4 bg-gradient-to-r from-[#046BD2] to-[#15ace6] hover:from-[#0353a4] hover:to-[#0d99d1] active:scale-[0.99] text-white font-bold text-sm sm:text-base rounded-xl shadow-lg shadow-sky-500/25 transition-all flex items-center justify-center space-x-2 disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                      {isSubmitting ? (
                        <>
        ...
        <section className="relative w-full h-[400px] sm:h-[460px] bg-slate-100 overflow-hidden border-t border-slate-200">
          ...
          <div className="absolute top-6 left-6 z-20 bg-white px-5 py-3.5 rounded-2xl shadow-xl shadow-slate-900/10 border border-slate-100 flex items-center space-x-4 max-w-sm">
            <div>
              <h4 className="text-sm font-black text-[#031b4e]">Hall Road</h4>
              <p className="text-xs text-slate-500 mt-0.5 leading-tight font-normal">
            ...
            <div className="flex items-center space-x-1.5 pl-2 border-l border-slate-100">
              <a
                ...
                className="w-8 h-8 rounded-lg bg-slate-50 hover:bg-sky-50 text-slate-600 hover:text-[#046BD2] flex items-center justify-center transition-colors"
              >
              ...
              <a
                ...
                className="w-8 h-8 rounded-lg bg-[#046BD2] text-white flex items-center justify-center hover:bg-[#0353a4] transition-colors shadow-sm"
              >
