        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 relative">
              ...
              <div className="absolute -bottom-6 -right-2 sm:right-6 bg-gradient-to-r from-[#046BD2] to-[#15ace6] text-white p-6 rounded-2xl shadow-xl max-w-xs">
            ...
            <div className="lg:col-span-6 space-y-6 text-left">
              <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-sky-50 text-[#046BD2] border border-sky-200 text-xs font-bold uppercase tracking-wider">
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="p-4 rounded-2xl bg-[#f2f9fd] border border-sky-100">
                  <div className="text-2xl font-black text-[#046BD2]">80+</div>
                  <div className="text-xs font-bold text-[#031b4e] mt-1">Clients Served</div>
                </div>
                <div className="p-4 rounded-2xl bg-[#f2f9fd] border border-sky-100">
                  <div className="text-2xl font-black text-[#046BD2]">95%</div>
                  <div className="text-xs font-bold text-[#031b4e] mt-1">Client Retention</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-[#f2f9fd]/50 border-y border-sky-100/70">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Mission Card */}
            <div className="bg-white p-8 sm:p-10 rounded-3xl border border-sky-100 shadow-sm space-y-4 text-left group hover:border-[#046BD2] transition-colors">
              <div className="w-14 h-14 rounded-2xl bg-sky-50 group-hover:bg-[#046BD2] group-hover:text-white text-[#046BD2] flex items-center justify-center transition-colors">
              ...
              <ul className="space-y-2 pt-2 text-sm text-[#031b4e]">
                <li className="flex items-center space-x-2">
                  <CheckCircle2 className="w-4 h-4 text-[#046BD2]" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
            {[
              ...
              <div key={idx} className="bg-[#f2f9fd] p-8 rounded-3xl border border-sky-100 space-y-4">
                <div className="w-12 h-12 rounded-xl bg-white text-[#046BD2] shadow-sm flex items-center justify-center">
                  <val.icon className="w-6 h-6" />
                </div>
                <h4 className="text-lg font-bold text-[#031b4e]">{val.title}</h4>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <button
              ...
              className="px-8 py-3.5 bg-gradient-to-r from-[#046BD2] to-[#15ace6] hover:from-[#0353a4] hover:to-[#0d99d1] text-white font-bold rounded-xl shadow-lg transition-all text-sm uppercase tracking-wider"
            >
              CONTACT US
            </button>
            <button
