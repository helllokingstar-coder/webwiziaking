...
export const servicesData: ServiceDetail[] = [
  {
    ...
    number: '01',
    title: 'Web Designing',
    shortDescription: 'Create modern, responsive and conversion-focused websites with professional UI/UX.',
    fullTitle: 'Professional Web Designing Services in Lahore & Worldwide',
    ...
    metaTitle: 'Professional Web Designing Services in Lahore | Webwizia',
  ...
  },
  {
    ...
    number: '02',
    title: 'SEO Services',
    shortDescription: 'Improve search visibility, organic traffic and online presence with effective SEO strategies.',
